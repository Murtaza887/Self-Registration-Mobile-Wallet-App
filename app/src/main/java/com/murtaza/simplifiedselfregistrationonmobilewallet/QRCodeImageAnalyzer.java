...
//    private ScanFragment.QRCodeFoundListener listener;
//
//    public QRCodeImageAnalyzer(ScanFragment.QRCodeFoundListener listener) {
...
//
//            PlanarYUVLuminanceSource source = new PlanarYUVLuminanceSource(imageData, image.getWidth(), image.getHeight(), 0, 0, image.getWidth(), image.getHeight(), false);
//
